...
- Local docs index: `docs/README.md` (includes `docs/style-guide.md`)
...
- **Storage-Aware Payloads**: The SDK resolves storage references and offloads large inputs/outputs without controller-side storage access.

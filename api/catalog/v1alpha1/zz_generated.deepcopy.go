...
func (in *EngramTemplateSpec) DeepCopyInto(out *EngramTemplateSpec) {
	*out = *in
	...
	if in.DeclaredOutputKeys != nil {
		in, out := &in.DeclaredOutputKeys, &out.DeclaredOutputKeys
...
func (in *TemplateExecutionPolicy) DeepCopyInto(out *TemplateExecutionPolicy) {
	*out = *in
	...
	if in.Storage != nil {
		...
		*out = new(TemplateStoragePolicy)
		(*in).DeepCopyInto(*out)
	}
	if in.RBAC != nil {
		in, out := &in.RBAC, &out.RBAC
		*out = new(TemplateRBACPolicy)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TemplateFileStorageProvider) DeepCopyInto(out *TemplateFileStorageProvider) {
	*out = *in
	if in.EmptyDir != nil {
...
func (in *TemplateFileStorageProvider) DeepCopy() *TemplateFileStorageProvider {
	if in == nil {
		return nil
	}
	out := new(TemplateFileStorageProvider)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TemplateS3Authentication) DeepCopy() *TemplateS3Authentication {
	if in == nil {
		return nil
	}
	out := new(TemplateS3Authentication)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TemplateS3StorageProvider) DeepCopyInto(out *TemplateS3StorageProvider) {
	*out = *in
	in.Authentication.DeepCopyInto(&out.Authentication)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TemplateS3StorageProvider.
func (in *TemplateS3StorageProvider) DeepCopy() *TemplateS3StorageProvider {
	if in == nil {
		return nil
	}
	out := new(TemplateS3StorageProvider)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TemplateStoragePolicy) DeepCopy() *TemplateStoragePolicy {
	if in == nil {
		return nil
	}
	out := new(TemplateStoragePolicy)

...
type HandoffStatus struct {
	...
	// +optional
	Strategy *bubuv1alpha1.TransportUpgradeStrategy `json:"strategy,omitempty"`
...
type StepRunStatus struct {
	...
	// Must conform to the StructuredError v1 contract (docs/contracts/steprun-error.schema.json).
	// Examples:

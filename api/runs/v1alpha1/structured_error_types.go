...
// +kubebuilder:validation:Enum=timeout;storage_error;serialization_error;validation_error;initialization_error;execution_error;unknown
...
// StructuredErrorExitClass mirrors the platform retry classification used in
// structured StepRun error payloads.

...
type TransportSpec struct {
	...
	// foo is an example field of Transport. Edit transport_types.go to remove/update
	// +optional
...
type TransportStatus struct {
	...
	// conditions represent the current state of the Transport resource.
...
type Transport struct {
	...
	// +optional
	Status TransportStatus `json:"status,omitempty,omitzero"`
}

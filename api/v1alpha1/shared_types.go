...
// TriggerDeliveryPolicy controls how Impulses deliver trigger events to Stories.
// Template policies provide defaults; Impulse policies can override them.
...
// TriggerDedupeMode enumerates supported dedupe strategies.
// +kubebuilder:validation:Enum=none;token;key
...
// TriggerThrottlePolicy configures per-trigger throttling for Impulses.
// These limits are enforced by the SDK in the Impulse workload.

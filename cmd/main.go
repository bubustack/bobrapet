...
//   - StoryWebhook, StoryRunWebhook, StepRunWebhook, EngramWebhook, and ImpulseWebhook
//     hold both a point-in-time ControllerConfig snapshot and a live ConfigManager
//     reference, so they re-fetch the effective config on each admission request.

...
func controllerConfigDefaults() ControllerConfig {
	return ControllerConfig{
		...
		RealtimeTTLSecondsAfterFinished: 0,
		MaxRetries:                      3,
...
// BuildStoryTriggerControllerOptions builds controller.Options for the StoryTrigger controller
// by applying global concurrency and standard exponential failure backoff.
//
// Returns:
//   - controller.Options: configured options used during controller registration.
...
// BuildEffectClaimControllerOptions builds controller.Options for the EffectClaim controller
// by applying global concurrency and standard exponential failure backoff.
//
// Returns:
//   - controller.Options: configured options used during controller registration.

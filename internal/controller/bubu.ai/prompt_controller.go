...
// +kubebuilder:rbac:groups=bubu.ai.bubu.sh,resources=prompts,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bubu.ai.bubu.sh,resources=prompts/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=bubu.ai.bubu.sh,resources=prompts/finalizers,verbs=update
...
func (r *PromptReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&bubuaiv1alpha1.Prompt{}).
		Named("bubu.ai-prompt").
		Complete(r)
}

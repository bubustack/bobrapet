...
var _ = Describe("ImpulseTemplate Controller", func() {
	Context("When reconciling a resource", func() {
		...
		BeforeEach(func() {
			By("creating the custom resource for the Kind ImpulseTemplate")
			err := k8sClient.Get(ctx, typeNamespacedName, impulsetemplate)
		...
		AfterEach(func() {
			...
			By("Cleanup the specific resource instance ImpulseTemplate")

...
// +kubebuilder:rbac:groups=transport.bubustack.io,resources=transports,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=transport.bubustack.io,resources=transports/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=transport.bubustack.io,resources=transports/finalizers,verbs=update

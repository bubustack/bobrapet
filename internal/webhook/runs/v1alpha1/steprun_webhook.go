...
const stepRunStructuredErrorSchemaV1 = `{
  ...
  "properties": {
    ...
    "exitClass": {
      "type": "string",
      "enum": ["success", "retry", "terminal", "rateLimited", "unknown"]
    },
    "code": {
      "type": "string"
    },
...
var _ admission.Defaulter[*runsv1alpha1.StepRun] = &StepRunCustomDefaulter{}
...
// Returns:
//   - nil on success.
func (d *StepRunCustomDefaulter) Default(_ context.Context, steprun *runsv1alpha1.StepRun) error {
...
var _ admission.Validator[*runsv1alpha1.StepRun] = &StepRunCustomValidator{}
...
func (v *StepRunCustomValidator) ValidateUpdate(ctx context.Context, oldSteprun, steprun *runsv1alpha1.StepRun) (admission.Warnings, error) {
	...
	if err := ensureStepRunObservedGenerationMonotonic(oldSteprun, steprun); err != nil {
		return nil, err
	}
	...
	if equality.Semantic.DeepEqual(oldSteprun.Spec, steprun.Spec) {
		return nil, nil
	}
...
func (v *StepRunCustomValidator) ValidateDelete(_ context.Context, steprun *runsv1alpha1.StepRun) (admission.Warnings, error) {
...
func validateStructuredErrorPayload(sr *runsv1alpha1.StepRun) error {
	if sr == nil || sr.Status.Error == nil {
		return nil
	}
	raw, err := json.Marshal(sr.Status.Error)
	if err != nil {
		return fmt.Errorf("failed to serialize status.error: %w", err)
	}
	raw = webhookshared.TrimLeadingSpace(raw)

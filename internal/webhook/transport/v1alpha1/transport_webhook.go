...
func (w *TransportWebhook) SetupWebhookWithManager(mgr ctrl.Manager) error {
	return ctrl.NewWebhookManagedBy(mgr, &transportv1alpha1.Transport{}).
...
var _ admission.Validator[*transportv1alpha1.Transport] = &TransportValidator{}

// ValidateCreate validates Transport creation requests.
//
// Behavior:
//   - Validates spec via validateTransport for field-level checks.
//
// Arguments:
//   - ctx context.Context: unused but required by interface.
//   - transport *transportv1alpha1.Transport: the Transport being created.
//
// Returns:
//   - nil, nil if validation passes.
//   - nil, error if validation errors exist.
func (v *TransportValidator) ValidateCreate(_ context.Context, transport *transportv1alpha1.Transport) (admission.Warnings, error) {
...
// Arguments:
//   - ctx context.Context: unused but required by interface.
//   - oldTransport *transportv1alpha1.Transport: previous Transport state.
//   - newTransport *transportv1alpha1.Transport: proposed Transport state.
//
// Returns:
//   - nil, nil if validation passes or is skipped.
//   - nil, error if validation errors exist.
func (v *TransportValidator) ValidateUpdate(_ context.Context, oldTransport, newTransport *transportv1alpha1.Transport) (admission.Warnings, error) {
...
func (v *TransportValidator) ValidateDelete(_ context.Context, transport *transportv1alpha1.Transport) (admission.Warnings, error) {
...
func (w *TransportBindingWebhook) SetupWebhookWithManager(mgr ctrl.Manager) error {
	return ctrl.NewWebhookManagedBy(mgr, &transportv1alpha1.TransportBinding{}).
...
var _ admission.Validator[*transportv1alpha1.TransportBinding] = &TransportBindingValidator{}

// ValidateCreate validates new TransportBinding resources.
//
// Behavior:
//   - Validates spec including lane requirements, transportRef, driver, and codec support.
//
// Arguments:
//   - ctx context.Context: for Transport lookup timeout.
//   - binding *transportv1alpha1.TransportBinding: the TransportBinding being created.
//
// Returns:
//   - nil, nil if validation passes.
//   - nil, error if validation errors exist.
func (v *TransportBindingValidator) ValidateCreate(ctx context.Context, binding *transportv1alpha1.TransportBinding) (admission.Warnings, error) {
...
// Arguments:
//   - ctx context.Context: for Transport lookup timeout.
//   - oldBinding *transportv1alpha1.TransportBinding: previous TransportBinding state.
//   - binding *transportv1alpha1.TransportBinding: proposed TransportBinding state.
//
// Returns:
//   - nil, nil if validation passes or is skipped.
//   - nil, error if validation errors exist.
func (v *TransportBindingValidator) ValidateUpdate(ctx context.Context, oldBinding, binding *transportv1alpha1.TransportBinding) (admission.Warnings, error) {
...
// Returns:
//   - nil, nil (deletion always allowed).
func (v *TransportBindingValidator) ValidateDelete(_ context.Context, binding *transportv1alpha1.TransportBinding) (admission.Warnings, error) {
...
func (v *TransportBindingValidator) validate(ctx context.Context, binding *transportv1alpha1.TransportBinding) (admission.Warnings, error) {
	...
	allErrs = append(
		allErrs,
		transportvalidation.ValidateTransportSecuritySettings(specPath.Child("rawSettings"), binding.Spec.RawSettings)...,
	)

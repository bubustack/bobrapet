...
func validBinding(name, namespace string) *transportv1alpha1.TransportBinding {
...
func TestTransportValidatorValidateCreate_WrongType(t *testing.T) {
	tv := &TransportValidator{}
	_, err := tv.ValidateCreate(context.Background(), &transportv1alpha1.TransportBinding{})
	if err == nil {
		t.Fatal("expected error when obj is not a Transport")
	}
}
...
func TestTransportValidatorValidateUpdate_NewObjWrongType(t *testing.T) {
	tv := &TransportValidator{}
	_, err := tv.ValidateUpdate(context.Background(), validTransport("t"), &transportv1alpha1.TransportBinding{})
	if err == nil {
		t.Fatal("expected error when newObj is wrong type")
	}
}

// oldObj type assertion failure must return an error, consistent with newObj handling.
func TestTransportValidatorValidateUpdate_OldObjWrongType(t *testing.T) {
	tv := &TransportValidator{}
	_, err := tv.ValidateUpdate(context.Background(), &transportv1alpha1.TransportBinding{}, validTransport("t"))
	if err == nil {
		t.Fatal("expected error when oldObj is wrong type")
	}
}
...
func TestTransportBindingValidatorValidateCreate_Valid(t *testing.T) {
	...
	_, err := validator.ValidateCreate(context.Background(), validBinding("b", "default"))
	if err != nil {
		t.Fatalf("expected no error for valid binding, got %v", err)
	}
}

func TestTransportBindingValidatorValidateCreate_WrongType(t *testing.T) {
	validator := &TransportBindingValidator{
		Reader: fake.NewClientBuilder().WithScheme(newTransportScheme(t)).Build(),
	}
	_, err := validator.ValidateCreate(context.Background(), &transportv1alpha1.Transport{})
	if err == nil {
		t.Fatal("expected error when obj is not a TransportBinding")
	}
}
...
func TestTransportBindingValidatorValidateUpdate_NewObjWrongType(t *testing.T) {
	validator := &TransportBindingValidator{
		Reader: fake.NewClientBuilder().WithScheme(newTransportScheme(t)).Build(),
	}
	old := validBinding("b", "default")
	_, err := validator.ValidateUpdate(context.Background(), old, &transportv1alpha1.Transport{})
	if err == nil {
		t.Fatal("expected error when newObj is wrong type")
	}
}

func TestTransportBindingValidatorValidateUpdate_OldObjWrongType(t *testing.T) {
	validator := &TransportBindingValidator{
		Reader: fake.NewClientBuilder().WithScheme(newTransportScheme(t)).Build(),
	}
	_, err := validator.ValidateUpdate(context.Background(), &transportv1alpha1.Transport{}, validBinding("b", "default"))
	if err == nil {
		t.Fatal("expected error when oldObj is wrong type")
	}
}
...
func TestTransportBindingValidatorValidateDelete_AlwaysAllows(t *testing.T) {
	...
	_, err := validator.ValidateDelete(context.Background(), validBinding("b", "default"))
	if err != nil {
		t.Fatalf("expected no error on delete, got %v", err)
	}
}
...
func TestTransportBindingValidatorNilReader(t *testing.T) {
	...
	_, err := v.validate(context.Background(), validBinding("b", "default"))
	if err == nil {
...
func TestTransportBindingValidatorAPIError(t *testing.T) {
	...
	_, err := validator.validate(context.Background(), validBinding("b", "default"))
	if err == nil {
...
func TestTransportBindingValidatorTransportLookupCancelled(t *testing.T) {
	...
	_, err := validator.validate(ctx, validBinding("b", "default"))
	if err == nil {

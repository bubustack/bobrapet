...
func (wh *EngramWebhook) SetupWebhookWithManager(mgr ctrl.Manager) error {
	return ctrl.NewWebhookManagedBy(mgr, &bubushv1alpha1.Engram{}).
...
var _ admission.Defaulter[*bubushv1alpha1.Engram] = &EngramCustomDefaulter{}
...
func (d *EngramCustomDefaulter) Default(_ context.Context, engram *bubushv1alpha1.Engram) error {
	engramlog.Info("Defaulting Engram", "name", engram.GetName())
	return nil
}
...
var _ admission.Validator[*bubushv1alpha1.Engram] = &EngramCustomValidator{}

...
var _ = Describe("Story Webhook", func() {
	...
	Context("primitive validation", func() {
		...
		It("rejects gate steps in streaming stories", func() {
			...
			story.Spec.Pattern = enums.StreamingPattern
			story.Spec.Steps = []bubushv1alpha1.Step{{
				Name: "gate",
				Type: enums.StepTypeGate,
			}}
			...
			story.Spec.Transports = []bubushv1alpha1.StoryTransport{
				{
					Name:         "voice",
					TransportRef: "livekit",
					Streaming: &bubushv1alpha1.TransportStreamingSettings{
						Routing: &bubushv1alpha1.TransportRoutingSettings{
							Rules: []bubushv1alpha1.TransportRoutingRule{
								{
									Target: &bubushv1alpha1.TransportRoutingRuleTarget{
			...
			story.Spec.Transports = []bubushv1alpha1.StoryTransport{
				{
					...
					Streaming: &bubushv1alpha1.TransportStreamingSettings{
						Routing: &bubushv1alpha1.TransportRoutingSettings{
							Rules: []bubushv1alpha1.TransportRoutingRule{
								{
									Action: bubushv1alpha1.TransportRoutingRuleAction("block"),
								},
							},
						},
					},
			...
			story.Spec.Transports = []bubushv1alpha1.StoryTransport{
				{
					...
					TransportRef: "livekit",
					Streaming: &bubushv1alpha1.TransportStreamingSettings{
						Backpressure: &bubushv1alpha1.TransportBackpressureSettings{
							Buffer: &bubushv1alpha1.TransportBufferSettings{
								MaxMessages: int32Ptr(-1),
							},
						},
						FlowControl: &bubushv1alpha1.TransportFlowControlSettings{
							Mode: bubushv1alpha1.FlowControlMode("bogus"),
							AckEvery: &bubushv1alpha1.TransportFlowAckSettings{
								MaxDelay: stringPtr("not-a-duration"),
							},
						},
						Delivery: &bubushv1alpha1.TransportDeliverySettings{
							Replay: &bubushv1alpha1.TransportReplaySettings{
								CheckpointInterval: stringPtr("bad"),
							},
						},
						Routing: &bubushv1alpha1.TransportRoutingSettings{
							Mode:           bubushv1alpha1.TransportRoutingMode("mesh"),
							FanOut:         bubushv1alpha1.TransportFanOutMode("fanout"),
							MaxDownstreams: int32Ptr(0),
						},
						Partitioning: &bubushv1alpha1.TransportPartitioningSettings{
							Mode:       bubushv1alpha1.TransportPartitionMode("range"),
							Key:        stringPtr(" "),
							Partitions: int32Ptr(0),
						},
						Lifecycle: &bubushv1alpha1.TransportLifecycleSettings{
							Strategy:            bubushv1alpha1.TransportUpgradeStrategy("invalid"),
							DrainTimeoutSeconds: int32Ptr(-1),
						},
						Observability: &bubushv1alpha1.TransportObservabilitySettings{
							Tracing: &bubushv1alpha1.TransportTracingSettings{
								SampleRate:   int32Ptr(200),
								SamplePolicy: stringPtr("maybe"),
							},
						},
						Recording: &bubushv1alpha1.TransportRecordingSettings{
							Mode:             bubushv1alpha1.TransportRecordingMode("full"),
							SampleRate:       int32Ptr(200),

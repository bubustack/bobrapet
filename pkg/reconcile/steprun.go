...
import (
	...
	"github.com/bubustack/bobrapet/pkg/runs/childrun"
...
func UpdateStepRunSpec(existing, desired *runsv1alpha1.StepRun) bool {
	...
	if childrun.UpdateRequestedManifest(&existing.Spec.RequestedManifest, desired.Spec.RequestedManifest, true) {
		changed = true
	}

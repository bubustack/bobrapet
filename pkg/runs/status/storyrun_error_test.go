...
func TestBuildStoryRunError_BasicFailure(t *testing.T) {
	...
	ext := BuildStoryRunError(conditions.ReasonDependencyFailed, "Story completed with failed step: deploy.", failedSteps, stepStates) //nolint:lll
...
func TestBuildStoryRunError_CompensationFailure(t *testing.T) {
	...
	ext := BuildStoryRunError(conditions.ReasonCompensationFailed, "Compensation step rollback failed.", failedSteps, stepStates) //nolint:lll
	require.NotNil(t, ext)
